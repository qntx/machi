...
pub trait PromptAssembler: Send + Sync {
    ...
    fn assemble(&self, definition: &AgentDefinition) -> Result<String, OvoError>;
}
...
impl ProjectPromptAssembler {
    ...
    pub fn from_project(cwd: impl AsRef<Path>) -> Result<Self, OvoError> {
    ...
    pub fn from_path(path: impl AsRef<Path>) -> Result<Self, OvoError> {
