...
pub struct SummarizingCompaction {
    ...
    pub summarize: std::sync::Arc<dyn Fn(Vec<Message>) -> Result<String, MachiError> + Send + Sync>,
}
...
mod tests {
    ...
    fn prune_shortens_tool_bodies() {
        ...
        let call = machi_types::ToolCall {
            id: machi_types::ToolCallId::new("c").expect("id"),
            name: "t".into(),
        ...
        let out = s
            .compact(vec![
                ...
                Message::tool_result(
                    machi_types::ToolCallId::new("c").expect("id"),
                    "t",
                    "1234567890",
                ),
            ])
